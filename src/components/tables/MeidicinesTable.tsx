...
const MedicinesTable: React.FunctionComponent = () => {
    ...
    const { data: medicines } = api.medicine.get_all.useQuery(undefined, {
    ...
    const deleteMedicine = api.medicine.delete.useMutation({
    ...
    return (
        <div className="h-full w-full">
            ...
            >
                <FinalizePopup
                    onYesClick={() => {
                        deleteMedicine.mutate(item);
                    }}
                    onNoClick={handleClose}
                    heading="Do you want to delete this medicine?"
                />
            </Modal>
            <Modal
                aria-labelledby="unstyled-modal-title"
            ...
            >
                <SuccessPopup
                    ...
                    message="The Medicine is Successfully Deleted"
                />
            </Modal>
            <Modal
                aria-labelledby="unstyled-modal-title"
