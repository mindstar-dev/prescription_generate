...
const RepetitionsTable: React.FunctionComponent = () => {
    ...
    const { data: repetitions } = api.medicine.get_repetitions.useQuery(undefined, {
    ...
    const deletetest = api.medicine.deleteRepition.useMutation({
    ...
    return (
        <div className="h-full w-full">
            ...
            >
                <FinalizePopup
                    onYesClick={() => {
                        deletetest.mutate(item);
                    }}
                    onNoClick={handleClose}
                    heading="Do you want to delete this repetition?"
                />
            </Modal>
            <Modal
                aria-labelledby="unstyled-modal-title"
            ...
            >
                <SuccessPopup
                    ...
                    message="The repetition is Successfully Deleted"
                />
            </Modal>
            <Modal
                aria-labelledby="unstyled-modal-title"
